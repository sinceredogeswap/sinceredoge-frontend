...
export const INFO_CLIENT = 'https://api.thegraph.com/subgraphs/name/sinceredoge/exchange'
export const BLOCKS_CLIENT = 'https://api.thegraph.com/subgraphs/name/sinceredoge/blocks'
